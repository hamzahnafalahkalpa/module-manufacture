...
namespace Hanafalah\ModuleManufacture\Facades;
 ...
 */
class ModuleManufacture extends \Illuminate\Support\Facades\Facade
{
  /**
  ...
  {
    return \Hanafalah\ModuleManufacture\Contracts\ModuleManufacture::class;
  }
}
